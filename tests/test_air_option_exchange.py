...
class TestAirOptionFlightsExchange(TestCase):
    ...
    def test_basic(self):
        """ Tests if AirOptionFlightsExchange even runs.
        """

        flights = [(100., datetime.date(2019, 7, 15), 'UA70'), (200., datetime.date(2019, 7, 20), 'UA71')]
        strike_flight = (100., datetime.date(2019, 7, 30), 'UA72')  # "strike" flight

        aof = AirOptionFlightsExchange( datetime.date(2019, 6, 28)
                              , flights
                              , K = strike_flight )
        ...
        strike_flight_ret = (180., datetime.date(2019, 7, 26), 'UA74')

        aof2 = AirOptionFlightsExchange(datetime.date(2019, 6, 28), (flights, flights_ret), K=(strike_flight, strike_flight_ret))
