...
def compute_option_val( origin_place='SFO'
    ...
    return compute_option_from_flights(flights
                               ...
                               , outbound_date_start=outbound_date_start
                               , inbound_date_start=outbound_date_end
                               , K=K
                               , nb_sim=nb_sim
                               , rho=rho
                               , adults=adults
                               ...
                               , return_flight=return_flight
                               , complete_set_options=complete_set_options )


def compute_option_from_flights( flights
                               ,  option_start_date=None
                               , option_end_date=None
                               , option_ret_start_date=None
                               , option_ret_end_date=None
                               ...
                               , complete_set_options=3 ):
    """
    Computes the air option from the flights provided.
